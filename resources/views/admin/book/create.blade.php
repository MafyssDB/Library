                ...
                <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" id="exampleInputEmail1" placeholder="Введите Название книги">
                        </div>
                        @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input name="author" type="text" class="form-control" id="exampleInputPassword1" placeholder="Автор">
                        </div>
                        @error('author')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
